(function(){
  ...
  window.addEventListener('ldfcloudready',()=>{ bindAuthChanges(); syncAuthBar(); });
  window.addEventListener('focus',syncAuthBar);
  document.addEventListener('visibilitychange',()=>{ if(!document.hidden) syncAuthBar(); });
